...
import (
	...
	"github.com/cdktf/cdktf-provider-template-go/template/v10/datatemplatefile/internal"
...
func DataTemplateFile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataTemplateFile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataTemplateFile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataTemplateFile) ToHclTerraform() interface{} {
	var returns interface{}
