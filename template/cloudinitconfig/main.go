...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-template.cloudinitConfig.CloudinitConfigConfig",
		reflect.TypeOf((*CloudinitConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-template.cloudinitConfig.CloudinitConfigPart",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-template.cloudinitConfig.CloudinitConfigPartOutputReference",
