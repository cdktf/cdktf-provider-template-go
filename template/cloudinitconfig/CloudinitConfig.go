...
import (
	...
	"github.com/cdktf/cdktf-provider-template-go/template/v10/cloudinitconfig/internal"
...
func (j *jsiiProxy_CloudinitConfig) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewCloudinitConfig(scope constructs.Construct, id *string, config *CloudinitConfigConfig) CloudinitConfig {
	...
	if err := validateNewCloudinitConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_CloudinitConfig{}

	_jsii_.Create(
		"@cdktf/provider-template.cloudinitConfig.CloudinitConfig",
...
func (j *jsiiProxy_CloudinitConfig)SetCount(val interface{}) {
...
func CloudinitConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudinitConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudinitConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudinitConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudinitConfig_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudinitConfig_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudinitConfig_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudinitConfig_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudinitConfig) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudinitConfig) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudinitConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudinitConfig) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudinitConfig) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudinitConfig) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudinitConfig) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudinitConfig) ToHclTerraform() interface{} {
	var returns interface{}
