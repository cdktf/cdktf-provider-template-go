...
func (c *jsiiProxy_CloudinitConfig) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (c *jsiiProxy_CloudinitConfig) validateImportFromParameters(id *string) error {
	return nil
}
...
func (c *jsiiProxy_CloudinitConfig) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (c *jsiiProxy_CloudinitConfig) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (c *jsiiProxy_CloudinitConfig) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateCloudinitConfig_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
