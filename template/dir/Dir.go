...
import (
	...
	"github.com/cdktf/cdktf-provider-template-go/template/v10/dir/internal"
...
func (j *jsiiProxy_Dir) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Dir)SetCount(val interface{}) {
...
func Dir_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDir_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_Dir) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_Dir) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_Dir) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_Dir) MoveFromId(id *string) {
...
func (d *jsiiProxy_Dir) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_Dir) MoveToId(id *string) {
...
func (d *jsiiProxy_Dir) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_Dir) ToHclTerraform() interface{} {
	var returns interface{}
