...
import (
	...
	"github.com/cdktf/cdktf-provider-template-go/template/v10/provider/internal"
...
func NewTemplateProvider(scope constructs.Construct, id *string, config *TemplateProviderConfig) TemplateProvider {
	...
	_jsii_.Create(
		"@cdktf/provider-template.provider.TemplateProvider",
...
func TemplateProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTemplateProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func TemplateProvider_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTemplateProvider_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TemplateProvider_IsTerraformProvider(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTemplateProvider_IsTerraformProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TemplateProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TemplateProvider) ToHclTerraform() interface{} {
	var returns interface{}
