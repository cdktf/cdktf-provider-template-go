...
import (
	...
	"github.com/cdktf/cdktf-provider-template-go/template/v10/datatemplatecloudinitconfig/internal"
...
func (j *jsiiProxy_DataTemplateCloudinitConfig) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataTemplateCloudinitConfig)SetCount(val interface{}) {
...
func DataTemplateCloudinitConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataTemplateCloudinitConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataTemplateCloudinitConfig) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataTemplateCloudinitConfig) ToHclTerraform() interface{} {
	var returns interface{}
