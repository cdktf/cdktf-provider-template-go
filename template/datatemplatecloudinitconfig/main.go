...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-template.dataTemplateCloudinitConfig.DataTemplateCloudinitConfigConfig",
		reflect.TypeOf((*DataTemplateCloudinitConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-template.dataTemplateCloudinitConfig.DataTemplateCloudinitConfigPart",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-template.dataTemplateCloudinitConfig.DataTemplateCloudinitConfigPartOutputReference",
